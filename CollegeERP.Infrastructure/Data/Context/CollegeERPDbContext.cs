...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-EQ13CS6\\SQLEXPRESS;Database=CollegeERP;Trusted_Connection=True;TrustServerCertificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Department>(entity =>
        {
            ...
            entity.HasIndex(e => e.DepartmentCode, "UQ_Dep_code").IsUnique();

            entity.HasIndex(e => e.DepartmentName, "UQ_Dep_name").IsUnique();
        ...
        {
            entity.HasKey(e => e.StudentId).HasName("PK__StudentP__32C52B99E18BAD58");
            ...
            entity.Property(e => e.FatherName)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.LastQualification)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.PhoneNumber)
                .HasMaxLength(15)
                .IsUnicode(false);
            entity.Property(e => e.Status).HasDefaultValue((byte)1, "DF_StudentProfile_Status");
